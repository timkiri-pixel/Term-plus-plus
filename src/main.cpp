...
int main() {
  ...
  // Optional welcoming
  std::cout << "Welcome to Term++ v" << VERSION
            << " :D (experimental branch)\n";

  // the main loop that runs the terminal
  while (true) {
    // declare the userInput variable for storing user's input; declare the name
